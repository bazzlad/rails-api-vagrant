...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { name: @hotel.name, packages: @hotel.packages, tags: @hotel.tags } }, as: :json
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { name: @hotel.name, packages: @hotel.packages, tags: @hotel.tags } }, as: :json
    assert_response 200
  end
